    ...
    public class JumpPredictionController : MonoBehaviour
    {
        ...
        public void FreeJump()
        {
            if (!controller.isJumping && controller.characterInput.jump)
            {
                ...
                // 카메라의 방향을 기준으로 입력 방향을 변환합니다.
                Vector3 camForward = camTransform.forward;
                camForward.y = 0; // y축은 고려하지 않습니다.
                ...
                Vector3 inputDir = controller.characterInput.movement.y * camForward + controller.characterInput.movement.x * camRight;
                inputDir.Normalize();
